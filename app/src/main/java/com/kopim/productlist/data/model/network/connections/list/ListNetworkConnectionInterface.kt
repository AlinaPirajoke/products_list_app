...
interface ListNetworkConnectionInterface {
    val lastIncomingCartData: MutableStateFlow<ProductListData?>
    ...
    suspend fun checkProducts(items: List<CheckedProductData>): Response<Unit>?

    suspend fun renameProducts(items: List<RenamedProductData>): Response<Unit>?
